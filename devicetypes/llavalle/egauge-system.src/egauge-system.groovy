...
metadata {
	...
	tiles(scale:2) {
        multiAttributeTile(name:"totalbig", type: "generic", width: 6, height: 4){
            tileAttribute ("device.power", key: "PRIMARY_CONTROL") {
                attributeState "power", label:'${currentValue}W',unit:"W",
                    backgroundColors:[
                        ...
                        [value: 5000, color: "#44b621"],
                        [value: 10000, color: "#f1d801"],
                        [value: 20000, color: "#d04e00"],
                        [value: 30000, color: "#bc2323"]
                    ]
            }
        }
            ...
            standardTile("refresh", "device.energy_today", decoration: "flat", width: 2, height: 2) {
                state "default", action:"polling.poll", icon:"st.secondary.refresh"
            }

        
        main (["totalbig","maingrid", "bachgrid"])
